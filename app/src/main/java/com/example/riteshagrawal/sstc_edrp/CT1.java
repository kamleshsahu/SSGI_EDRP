...
public class CT1 extends Fragment {
    ...
    Boolean oncreateCreated1=false;
    public CT1() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        after_gotUsersInfo = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                if (data.getResult().equals("success")) {
                    Worker w = new Worker(getActivity(), "fetch_RCdetails_ct1", sd, after_fetchRCdetails);
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser && ReportCardActivity.tabindex == 1) {
