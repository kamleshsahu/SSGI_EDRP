...
public class M1 extends Fragment {
    ...
    static SharedPreferences sd=baseactivity.sd;
    ListView listview;
...
//    static int flag =0;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        after_gotUsersInfo = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                if (data.getResult().equals("success")) {
                    Worker w = new Worker(getActivity(), "fetch_RCdetails_m1", sd, after_fetchRCdetails);
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        System.out.println("SetUserVisible,isVisibleToUser :"+isVisibleToUser+",current tab :"+ ReportCardActivity.tabindex);
        if (isVisibleToUser && ReportCardActivity.tabindex == 0) {
...
//
            ...
            System.out.println("else part of isVisibleToUser && tbts_test.tabindex :"+ ReportCardActivity.tabindex);
        }
    }
